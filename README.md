...
После запуска отправьте боту сообщение или команду `/start` в Telegram. Если сообщений нет,
бот просто ждёт новые апдейты.
...
1. Убедитесь, что вы отправили сообщение или `/start` именно этому боту.
